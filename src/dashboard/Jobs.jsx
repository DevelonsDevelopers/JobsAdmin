...
const jobs = [
  { title: "UI", cat: "Design", city: "Lahore", company: 'Devsinc', role: 'Manager', status: "Active", },
  { title: "UI", cat: "Design", city: "Lahore", company: 'Devsinc', role: 'Manager', status: "Active", },
  { title: "UI", cat: "Design", city: "Lahore", company: 'Devsinc', role: 'Manager', status: "Active", },
  { title: "UI", cat: "Design", city: "Lahore", company: 'Devsinc', role: 'Manager', status: "Active", },
...
const Jobs = () => {
  ...
  return (
    <PortalLayout>
      <h1 className='text-[3.125rem] font-[800] text-[#000] text-center'>Jobs</h1>
      ...
      <div className="w-[100%] max-md:h-full bg-white rounded-xl shadow-md  my-[3%] py-10 px-[6rem] max-md:px-2 flex flex-col justify-center bg-gray-100">
        <div className='flex  items-center'>
          ...
          <a href="/jobs/add"> <button className="bg-blue-600 hover:bg-blue-700 cursor-pointer  max-md:text-[.6rem] py-2 px-[1rem] max-md:px-[1rem] max-md:py-[9px] text-white font-[600] max-md:font-[400] rounded-xl ml-[1rem] max-md:mr-10"  >
            Add New
          </button>
          </a>
        ...
        <div className="rounded-xl bg-blue-600 border-2 border-blue-100 shadow-md shadow-blue-100  w-[100%] max-md:w-[100%]  mt-10 ">
          <thead className=' rounded-t-lg'>
            <tr className=" text-white  uppercase text-sm leading-normal w-[100%]">
              <th className="py-[2%] w-[6%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[2%]">Title</th>
              <th className="py-[2%] w-[2%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[3%]">category</th>
              <th className="py-[2%] w-[2%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[3%]">City</th>
              <th className="py-[2%] w-[2%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[3%]">Company</th>
              <th className="py-[2%] w-[2%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[3%]">Role</th>
            ...
            <tbody className="text-gray-600 text-sm font-light w-[100%] bg-white ">
              <tr className={`border-b border-gray-300  ${index % 2 ? "bg-blue-100" : "bg-white"}`} >
                <td className="py-[2%] w-[6%] max-md:text-[.7rem] text-center">
                  <span className="font-bold text-[1rem]">{value.title}</span>
                </td>
                <td className="py-[1%] w-[6%] w-[20%] max-md:text-[.7rem] text-center">
                  <span className='font-bold'>{value.cat}</span>
                </td>
                <td className="py-[1%] w-[6%] w-[20%] max-md:text-[.7rem] text-center">
                  <span className='font-bold'>{value.city}</span>
                </td>
                <td className="py-[1%] w-[6%] w-[20%] max-md:text-[.7rem] text-center">
                  <span className='font-bold'>{value.company}</span>
                </td>
                <td className="py-[1%] w-[6%] w-[20%] max-md:text-[.7rem] text-center">
                  <span className='font-bold'>{value.role}</span>
                </td>
                ...
                <td className="py-[2%] w-[4%] max-md:text-[.7rem] text-center">
                  <div className="flex item-center justify-center gap-3">
                    ...
                    <div className="w-4 mr-2 transform hover:text-blue-500  hover:scale-110" onClick={() => router("/jobs/edit")}>
