            ...
            <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
                ...
                <div class="-mx-3 md:flex mb-2">
                    <div class="md:w-1/2 px-3">
                        ...
                        <div class="relative">
                            <select onChange={ClickInput} name='category' class="pl-4 block py-2.5 px-0 w-full text-md text-gray-900 bg-transparent rounded-xl p-2 border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" id="grid-state">
