              ...
              <div className='flex-col'>
                <div className="-mx-3 mt-[-1.2rem] mb-6">
                  ...
                  <div className="w-[50%] px-3  mt-5 mb-6 md:mb-0">
                    ...
                    <select onChange={ClickInput} name='country' class="pl-4 block py-[9px] px-0 w-full text-sm text-gray-500 bg-gray-50 rounded-[9px] border-[0.7px] border-gray-300 appearance-none    border-gray-600  focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" id="grid-state">
