...
const catagory = [
  { name: "london", count: '20', status: "Active", },
  { name: "london", count: '20', status: "Active", },
  { name: "london", count: '20', status: "Active", },
  { name: "london", count: '20', status: "Active", },
...
const Categories = () => {
  ...
  return (
    <PortalLayout>
      ...
      <h1 className='text-center bg-gradient-to-r from-sky-600 to-cyan-400 text-white font-[600] mb-5 py-4 rounded-xl shadow-md shadow-blue-300 text-[1.5rem]'>Categories</h1>
      ...
      <div className="w-[100%] max-md:h-full bg-white rounded-xl shadow-md  my-[3%] py-10 px-[6rem] max-md:px-2 flex flex-col justify-center bg-gray-100">
        <div className='flex  items-center'>
          ...
          <a href="/categories/add"> <button className="bg-gradient-to-r from-sky-600 to-cyan-500 hover:bg-blue-700 cursor-pointer  max-md:text-[.6rem] py-2 px-[1rem] max-md:px-[1rem] max-md:py-[9px] text-white font-[600] max-md:font-[400] rounded-xl ml-[1rem] max-md:mr-10"  >
            Add New
          </button>
          </a>
                ...
                <td className="py-[2%] w-[4%] max-md:text-[.7rem] text-center">
                  <div className="flex item-center justify-center gap-3">
                    <div className="w-4 mr-2 transform hover:text-blue-500  hover:scale-110">
                      <svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" onClick={() => router("/category/edit")}>
