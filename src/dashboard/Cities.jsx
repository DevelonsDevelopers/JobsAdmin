...
const city = [
  { name: "UK", count: '20', status: "Active", },
  { name: "FRANCE", count: '20', status: "Active", },
    ...
    <PortalLayout>
      ...
      <div className="w-[100%] max-md:h-full bg-white rounded-xl shadow-md  my-[3%] py-10 px-[6rem] max-md:px-2 flex flex-col justify-center bg-gray-100">
        <div className='flex  items-center'>
          ...
          <a href="/cities/add"> <button className="bg-blue-600 hover:bg-blue-700 cursor-pointer  max-md:text-[.6rem] py-2 px-[1rem] max-md:px-[1rem] max-md:py-[9px] text-white font-[600] max-md:font-[400] rounded-xl ml-[1rem] max-md:mr-10"  >
            Add New
          </button>
          </a>
