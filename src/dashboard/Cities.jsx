...
const city = [
  {name: "UK", description: "Help people interested in this repository ", image: "/assets/profile_thumb.png", alt:'london',status: "Active",},
  {name: "France", description: "Help people interested in this repository ", image: "/assets/profile_thumb.png", alt:'london',status: "Active",},
...
const Cities = () => {
  return (
    <PortalLayout>
      <h1 className='text-center bg-blue-400 text-white font-[600] mb-5 py-4 rounded-xl shadow-md shadow-blue-300 text-[1.5rem]'>City</h1>
      ...
      <div className="w-[100%] max-md:h-full bg-white rounded-xl shadow-md  my-[3%] py-10 px-[6rem] max-md:px-2 flex flex-col justify-center bg-gray-100">
        <div className='flex justify-between items-center'>
         <a href="/cities/add"> <button className="bg-blue-400 cursor-pointer  max-md:text-[.6rem] py-2 px-[3rem] max-md:px-[1.5rem] text-white font-[600] rounded-3xl mr-[1rem]"  >
            Add New
          </button>
          </a>
