...
const company = [
  {id: "01", name: "Jane Doe", email: "jane@gmail.com", status: "Active",addres:'Help people interested in this repository understand your project by adding a README.'},
  {id: "01", name: "Jane Doe", email: "jane@gmail.com", status: "Active",addres:'Help people interested in this repository understand your project by adding a README.'},
  {id: "01", name: "Jane Doe", email: "jane@gmail.com", status: "Active",addres:'Help people interested in this repository understand your project by adding a README.'},
  {id: "01", name: "Jane Doe", email: "jane@gmail.com", status: "Active",addres:'Help people interested in this repository understand your project by adding a README.'},
  {id: "01", name: "Jane Doe", email: "jane@gmail.com", status: "Active",addres:'Help people interested in this repository understand your project by adding a README.'},
...
const Users = () => {
  ...
  return (
    <PortalLayout>
     <h1 className='text-center bg-blue-400 text-white font-[600] mb-5 py-4 rounded-xl shadow-md shadow-blue-300 text-[1.5rem]'>Users</h1>
...
<div className="w-[100%] max-md:h-full bg-white rounded-xl shadow-md  my-[3%] py-10 px-[6rem] max-md:px-2 flex flex-col justify-center bg-gray-100">
  <div className='flex justify-between items-center'>
    <a href="/users/add"> <button  className="bg-blue-400 cursor-pointer  max-md:text-[.6rem] py-2 px-[3rem] max-md:px-[1.5rem] text-white font-[600] rounded-3xl mr-[1rem]"  >
      Add New
    </button>
    </a>
  ...
  <table className="rounded-xl  shadow-xl w-[100%] max-md:w-[100%] max-md:h-[400px] mt-10 rounded-tr-lg">
    <thead>
      <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal w-[100%]">
        <th className="py-[2%] px-[6%] max-md:text-[.67rem] text-left max-md:px-[2%]">Id</th>
        <th className="py-[2%] px-[10%]  max-md:text-[.67rem] text-center max-md:px-[3%]">Name</th>
        <th className="py-[2%] px-[6%] max-md:text-[.67rem] text-center">Email</th>
        {/* <th className="py-[2%] px-[2%] max-md:text-[.67rem] text-center">Adress</th> */}
    ...
    {company.map((value, index) => (
      <tbody className="text-gray-600 text-sm font-light w-[100%]">
        <tr className={`border-b border-gray-300 bg-white  ${index % 2 ? "bg-blue-100" : "bg-white"}`} >
          ...
          <td className="py-[2%] px-[10%] text-center max-md:text-[.7rem] ">
            <span>{value.name}</span>
          </td>
          <td className="py-[2%] px-[6%] max-md:ml-[1rem] max-md:text-[.6rem] max-md:px-[2%]  text-center">
            <div className="flex items-center justify-center text-blue-700 font-[700] ">
             {value.email} 
            </div>
          </td>
          {/* <td className="py-[2%] px-[2%] w-[20%] max-md:text-[.6rem] max-md:px-[2%]  text-center">
            <div className="flex items-center  justify-center font-[700] ">
             {value.addres} 
            </div>
          </td> */}
          ...
          <td className="py-[2%] px-[4%] max-md:text-[.7rem] text-center">
            <div className="flex item-center justify-center">
              <div className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110"  onClick={() => router("/users/edit")}>
              ...
              <div className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110" onClick={() => setOpen(true)}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
