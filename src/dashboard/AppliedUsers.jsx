...
const AppliedUsers = () => {
  return (
    <PortalLayout>
      <h1 className='text-center bg-blue-400 text-white font-[600] mb-5 py-4 rounded-xl shadow-md shadow-blue-Australia text-[1.5rem]'>Countries</h1>
      ...
      <a href="/appliedusers/add">    <button className="bg-blue-400 cursor-pointer  max-md:text-[.6rem] py-2 px-[3rem] max-md:px-[1.5rem] text-white font-[600] rounded-3xl mr-[1rem]"  >
            Add New
          </button>
          </a>
        ...
        <table className="rounded-xl  shadow-xl w-[100%] max-md:w-[100%] max-md:h-[400px] mt-10 rounded-tr-lg">
          <thead>
            <tr className="bg-gray-200 h-[3rem] text-gray-600 uppercase text-sm leading-normal  w-[100%]">
              <th className=" max-md:text-[.67rem] text-center max-md:px-[2%]">Users</th>
              <th className="max-md:text-[.67rem] text-center max-md:px-[3%]">Countries</th>
              <th className=" max-md:text-[.67rem] text-center">Cities</th>
              <th className=" max-md:text-[.67rem] text-center">Categories</th>
              <th className=" max-md:text-[.67rem] text-center">Status</th>
            </tr>
          </thead>
          {appliedusers.map((value, index) => (
            <tbody className="text-gray-600 text-sm font-light w-[100%]">
              <tr className={`border-b border-gray-300 h-[3rem] bg-white  ${index % 2 ? "bg-blue-100" : "bg-white"}`} >
                <td className="max-md:text-[.7rem] text-center">
                  <p className="font-medium">{value.user}</p>
                </td>
                ...
                <td className=" max-md:text-[.6rem] max-md:px-[2%]  text-center">
                  <div className="flex items-center justify-center text-blue-700 font-[700]">
