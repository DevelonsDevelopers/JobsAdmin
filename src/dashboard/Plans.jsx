        ...
        <tr className={`border-b border-gray-300  ${index % 2 ? "bg-blue-100" : "bg-white"}`} >
          ...
          <td className="py-[2%] w-[4%] max-md:text-[.7rem] text-center">
            <div className="flex item-center justify-center gap-3 max-md:gap-0">
              <div className="w-4 mr-2 max-md:w-3 max-md:ml-2 transform hover:text-blue-500  hover:scale-110"  onClick={() => router("/plans/edit")}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                </svg>
              </div>
              <div className="w-4 mr-2 max-md:w-3 max-md:mr-0 transform hover:text-blue-500  hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
