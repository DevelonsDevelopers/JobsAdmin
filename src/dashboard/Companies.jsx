...
const Companies = () => {
  return (
    <PortalLayout>
     <h1 className='text-center bg-blue-400 text-white font-[600] mb-5 py-4 rounded-xl shadow-md shadow-blue-300 text-[1.5rem]'>Comapnies</h1>
...
<div className="w-[100%] max-md:h-full bg-white rounded-xl shadow-md  my-[3%] py-10 px-[6rem] max-md:px-2 flex flex-col justify-center bg-gray-100">
  ...
  <a href="/companies/add"> <button className="bg-blue-400 cursor-pointer  max-md:text-[.6rem] py-2 px-[3rem] max-md:px-[1.5rem] text-white font-[600] rounded-3xl mr-[1rem]"  >
      Add New
    </button>
    </a> 
  ...
  <table className="rounded-xl  shadow-xl w-[100%] max-md:w-[100%] max-md:h-[400px] mt-10 rounded-tr-lg">
    <thead>
      <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal w-[100%]">
        <th className="py-[2%] px-[6%] max-md:text-[.67rem] text-center max-md:px-[2%]">Comapny</th>
        <th className="py-[2%] px-[2%] max-md:text-[.67rem] text-center max-md:px-[3%]">Description</th>
        <th className="py-[2%] px-[6%] max-md:text-[.67rem] text-center">Logo</th>
