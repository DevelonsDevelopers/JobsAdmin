...
const Tags = () => {
  ...
  return (
    <PortalLayout>
       <h1 className='text-center bg-blue-600 text-white font-[600] mb-5 py-4 rounded-xl shadow-md shadow-blue-300 text-[1.5rem]'>Tags</h1>
...
<div className="w-[100%] max-md:h-full bg-white rounded-xl shadow-md  my-[3%] py-10 px-[6rem] max-md:px-2 flex flex-col justify-center bg-gray-100">
  ...
  <div className="rounded-xl bg-blue-600 border-2 border-blue-100 shadow-md shadow-blue-100  w-[100%] max-md:w-[100%]  mt-10 ">
    ...
    {tags.map((value, index) => (
      <tbody className="text-gray-700 text-sm font-light w-[100%] bg-white ">
        <tr className={`border-b border-gray-300  ${index % 2 ? "bg-gray-100" : "bg-white"}`} >
