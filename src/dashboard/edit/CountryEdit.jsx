              ...
              <div className="">
                <div className="w-[100%] mb-6 md:mb-0">
                  ...
                  <input
                    ...
                    id="floating_email"
                    onChange={ClickInput}
                    className="pl-4 block py-[9px] px-0 w-full text-sm text-gray-900 bg-gray-100 rounded-[9px] border-[0.7px]  appearance-none   border-gray-600 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              ...
              <div className="-mx-3 mt-5 ">
                <div className="w-[100%]  px-3">
                  ...
                  <textarea
                    ...
                    rows="7"
                    onChange={ClickInput}
                    className="block w-full bg-gray-100  border-gray-lighte py-3 px-4 rounded-[9px] mb-3 border-[0.7px] border-gray-600 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer text-[14px]"
                    id="grid-Name"
                    type="text"
