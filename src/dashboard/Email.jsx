...
const Email = () => {
  return (
    <PortalLayout>
      <div>
      <h1 className='text-[3.125rem] font-[800] text-[#000] text-center max-md:text-[2rem]'>Jobs Emails</h1>
        <div className='flex justify-center mt-[3rem] w-[90%] m-auto'>
          ...
          <Link to="/email/add"> <button className="bg-[#0047FF] cursor-pointer  max-md:text-[.6rem] py-2 px-[1rem] max-md:px-[1rem] max-md:py-[5px] text-white font-[600] max-md:font-[400] rounded-[1.375rem] ml-auto "  >
            Add New
          </button>
          </Link>
          ...
          <tbody className="text-[#000000] text-sm font-light w-[100%] bg-white" >
            <tr className=''>
              <td className="py-[2%] w-[3%] border-r-[1px] border-t-[1px] text-center">
                <span className="font-bold max-md:text-[.7rem] text-[13px] text-blue-500">1</span> 
                {/* for value.id */}
              </td>
              <td className="py-[2%] w-[10%] border-r-[1px] border-t-[1px] text-center">
                <span className=" max-md:text-[.7rem] text-[13px] font-[350]">Email</span>        
                {/* for value.email */}
              </td>
