...
const Transactions = () => {
  return (
    <PortalLayout>
      ...
      <a href="/transactions/add">    <button className="bg-blue-400 cursor-pointer  max-md:text-[.6rem] py-2 px-[3rem] max-md:px-[1.5rem] text-white font-[600] rounded-3xl mr-[1rem]"  >
            Add New
          </button>
</a>
