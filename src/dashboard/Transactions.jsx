...
const transactions = [
  { date: "11/04/2023",  amount: "1000", type: "Credit", note: "aage string.",},
  { date: "11/04/2023",  amount: "1000", type: "Credit", note: "aage string.",},
  { date: "11/04/2023",  amount: "1000", type: "Credit", note: "aage string.",},
  { date: "11/04/2023",  amount: "1000", type: "Credit", note: "aage string.",},
  { date: "11/04/2023",  amount: "1000", type: "Credit", note: "aage string.",},
...
const Transactions = () => {
  return (
    <PortalLayout>
     <h1 className='text-center bg-gradient-to-r from-sky-600 to-cyan-400 text-white font-[600] mb-5 py-4 rounded-xl shadow-md shadow-blue-300 text-[1.5rem]'>Transactions</h1>
...
<div className="w-[100%] max-md:h-full bg-white rounded-xl shadow-md  my-[3%] py-10 px-[6rem] max-md:px-2 flex flex-col justify-center bg-gray-100">
  <div className='flex  items-center'>
    ...
    <a href="/transactions/add"> <button className="bg-gradient-to-r from-sky-600 to-cyan-500 hover:bg-blue-700 cursor-pointer  max-md:text-[.6rem] py-2 px-[1rem] max-md:px-[1rem] max-md:py-[9px] text-white font-[600] max-md:font-[400] rounded-xl ml-[1rem] max-md:mr-10"  >
      Add New
    </button>
    </a>
  ...
  <div className="rounded-xl bg-gradient-to-r from-sky-600 to-cyan-400 border-2 border-blue-100 shadow-md shadow-blue-100  w-[100%] max-md:w-[100%]  mt-10 ">
    <thead className=' rounded-t-lg'>
      <tr className=" text-white  uppercase text-sm leading-normal w-[100%]">
        ...
        <th className="py-[2%] w-[6%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[2%]">Type</th>
