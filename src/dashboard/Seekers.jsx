...
const appliedusers = [
  { user: "Jane", country: "U.S", status:'Active'},
  { user: "Jane", country: "U.S", status:'Active'},
  { user: "Jane", country: "U.S", status:'Active'},
  { user: "Jane", country: "U.S", status:'Active'},
  { user: "Jane", country: "U.S", status:'Active'},
...
const Seekers = () => {
  ...
  return (
    <PortalLayout>
      <h1 className='text-center bg-gradient-to-r from-sky-600 to-cyan-400 text-white font-[600] mb-5 py-4 rounded-xl shadow-md shadow-blue-300 text-[1.5rem]'>Seeker</h1>
...
<div className="w-[100%] max-md:h-full bg-white rounded-xl shadow-md  my-[3%] py-10 px-[6rem] max-md:px-2 flex flex-col justify-center bg-gray-100">
  <div className='flex  items-center'>
    ...
    <a href="/seekers/add"> <button className="bg-gradient-to-r from-sky-600 to-cyan-500 hover:bg-blue-700 cursor-pointer  max-md:text-[.6rem] py-2 px-[1rem] max-md:px-[1rem] max-md:py-[9px] text-white font-[600] max-md:font-[400] rounded-xl ml-[1rem] max-md:mr-10"  >
      Add New
    </button>
    </a>
  ...
  <div className="rounded-xl bg-gradient-to-r from-sky-600 to-cyan-400 border-2 border-blue-100 shadow-md shadow-blue-100  w-[100%] max-md:w-[100%]  mt-10 ">
    <thead className=' rounded-t-lg'>
      <tr className=" text-white  uppercase text-sm leading-normal w-[100%]">
        ...
        <th className="py-[2%] w-[6%] max-md:text-[.6rem] max-md:font-[400] text-center">Country</th>
        <th className="py-[2%] w-[9%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[3%]">Status</th>
      ...
      <tbody className="text-gray-600 text-sm font-light w-[100%] bg-white ">
        <tr className={`border-b border-gray-300  ${index % 2 ? "bg-blue-100" : "bg-white"}`} >
          ...
          <td className="py-[1%] w-[6%] w-[20%] max-md:text-[.7rem] text-center">
            <span className='font-bold'>{value.country}</span>
          </td>
          ...
          <td className="py-[2%] w-[4%] max-md:text-[.7rem] text-right pl-4">
