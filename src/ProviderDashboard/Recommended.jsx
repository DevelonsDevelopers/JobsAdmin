...
const Recommended = () => {
  ...
  useEffect(() => {
    if (recommendedSeeker !== null || recommendedSeeker !== undefined || recommendedSeeker.length !== 0) {
                ...
                <table className="rounded-xl shadow-lg p-5 bg-black text-gray-100 w-[90%] m-auto max-md:w-[100%]  mt-6 max-md:overflow-auto ">
                  <thead className='mt-10'>
                    <tr className=" uppercase  text-sm leading-normal w-[100%]">
                      ...
                      <th className="py-[2%] border-r-[1px] border-gray-300 border-b-[3px] border-gray-400-[3px]  w-[1%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[2%]  text-[13px]">Name</th>
                      <th className="py-[2%] border-r-[1px] border-gray-300 border-b-[3px] border-gray-400-[3px]  w-[1%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[2%]  text-[13px]">Role</th>
                      <th className="py-[2%] border-r-[1px] border-gray-300 border-b-[3px] border-gray-400-[3px]  w-[1%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[2%]  text-[13px]">offer</th>
                      <th className="py-[2%] border-r-[1px] border-gray-300 border-b-[3px] border-gray-400-[3px]  w-[1%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[2%]  text-[13px]">Address</th>
