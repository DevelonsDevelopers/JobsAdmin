                ...
                <table className="rounded-xl p-5 bg-black text-gray-100 w-[90%] m-auto max-md:w-[100%]  mt-6 max-md:overflow-auto">
                  <thead className="mt-10">
                    <tr className=" uppercase  text-sm leading-normal w-[100%]">
                      <th className="py-[2%] border-r-[1px] border-gray-300 border-b border-black-[3px]  w-[1%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[2%]  text-[13px]">
                        ID{" "}
                      </th>
                      <th className="py-[2%] border-r-[1px] border-gray-300 border-b border-black-[3px]  w-[1%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[1%]  text-[13px]">
                        Title{" "}
                      </th>
                      <th className="py-[2%] border-r-[1px] border-gray-300 border-b border-black-[3px]  w-[3%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[2%]  text-[13px]">
                        Category{" "}
                      </th>
                      <th className="py-[2%] border-r-[1px] border-gray-300 border-b border-black-[3px]  w-[3%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[2%]  text-[13px]">
                        City{" "}
                      ...
                      <th className="py-[2%] border-r-[1px] border-gray-300 border-b border-black-[3px] w-[1%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[3%] text-[13px]">
                        Role
                      </th>
                      <th className="py-[2%] border-r-[1px] border-gray-300 border-b border-black-[3px] w-[1%] max-md:text-[.6rem] max-md:font-[400] text-center max-md:w-[3%] text-[13px]">
                        Recommended
                      </th>
                      <th className="py-[2%] border-r-[1px] border-gray-300 border-b border-black-[3px] w-[2%] max-md:text-[.6rem] max-md:font-[400] text-center text-[13px]">
                        Status
                      </th>
