import { ALL_COMPANIES, COMPANY_STATUS, CREATE_COMPANIES, CREATE_COMPANY, DELETE_COMPANIES, DELETE_COMPANY, ERROR, GET_COMPANIES, GET_COMPANY, LOADING, RESET_STATE, SUCCESS, UPDATE_COMPANIES, UPDATE_COMPANY } from "../../Utils/Constant";
