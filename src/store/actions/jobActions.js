import { ALL_JOBS, CREATE_JOB, DELETE_JOB, GETCATEGORY_JOB, GETCITY_JOB, GETCOMPANY_JOB, GETCOUNTRY_JOB, GET_JOB, GET_JOBS, JOBS_STATUS, LOADING, RECENT_JOB, REMOVE_JOB, SUCCESS, UPDATE_JOB } from "../../Utils/Constant";
